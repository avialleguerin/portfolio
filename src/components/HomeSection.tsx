  ...
  return (
    ...
    >
      ...
      <main className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10">
        ...
        <h1 className="font-lemon text-5xl sm:text-7xl md:text-8xl lg:text-[120px] font-black tracking-[6px] sm:tracking-[8px] lg:tracking-[12px] text-white mb-6 sm:mb-8 [text-shadow:0_10px_30px_rgba(0,0,0,0.9)] leading-[1.1] break-words">
          AMANDINE
        </h1>
