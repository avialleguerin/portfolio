...
const ScrollIndicator = ({ onClick, className = '' }: ScrollIndicatorProps) => {
  ...
  return (
    ...
    >
      ...
      <span className="font-lagu font-medium [writing-mode:vertical-rl] text-[13px] tracking-[4px] text-white/50 hover:text-white transition-colors duration-300">SCROLL</span>
      {(() => {
        const isContact = className.includes('contact')
